...
void OLED_Status(void)
{
    ...
    if (OLEDDelay >= 30)
    {
        ...
        {
            sprintf(line, "LAT :  .-+-.-------  ");
            line[6] = GPS_coord[LAT]<0?'S':'N';
            line[8]  = '0' + GPS_coord[LAT]  / 1000000000;
            line[9]  = '0' + GPS_coord[LAT]  / 100000000 - (GPS_coord[LAT]/1000000000) * 10;
            line[10] = '0' + GPS_coord[LAT]  / 10000000  - (GPS_coord[LAT]/100000000)  * 10;
            line[12] = '0' + GPS_coord[LAT]  / 1000000   - (GPS_coord[LAT]/10000000)   * 10;
            line[13] = '0' + GPS_coord[LAT]  / 100000    - (GPS_coord[LAT]/1000000)    * 10;
            line[14] = '0' + GPS_coord[LAT]  / 10000     - (GPS_coord[LAT]/100000)     * 10;
            line[15] = '0' + GPS_coord[LAT]  / 1000      - (GPS_coord[LAT]/10000)      * 10;
            line[16] = '0' + GPS_coord[LAT]  / 100       - (GPS_coord[LAT]/1000)       * 10;
            line[17] = '0' + GPS_coord[LAT]  / 10        - (GPS_coord[LAT]/100)        * 10;
            line[18] = '0' + GPS_coord[LAT]              - (GPS_coord[LAT]/10)         * 10;
            i2c_OLED_LCDsetLine(3);
            i2c_OLED_LCDprintChar(line);
            sprintf(line, "LON :  .-+-.-------  ");
            line[6] = GPS_coord[LON]<0?'W':'E';
            line[8]  = '0' + GPS_coord[LON]  / 1000000000;
            line[9]  = '0' + GPS_coord[LON]  / 100000000 - (GPS_coord[LON]/1000000000) * 10;
            line[10] = '0' + GPS_coord[LON]  / 10000000  - (GPS_coord[LON]/100000000)  * 10;
            line[12] = '0' + GPS_coord[LON]  / 1000000   - (GPS_coord[LON]/10000000)   * 10;
            line[13] = '0' + GPS_coord[LON]  / 100000    - (GPS_coord[LON]/1000000)    * 10;
            line[14] = '0' + GPS_coord[LON]  / 10000     - (GPS_coord[LON]/100000)     * 10;
            line[15] = '0' + GPS_coord[LON]  / 1000      - (GPS_coord[LON]/10000)      * 10;
            line[16] = '0' + GPS_coord[LON]  / 100       - (GPS_coord[LON]/1000)       * 10;
            line[17] = '0' + GPS_coord[LON]  / 10        - (GPS_coord[LON]/100)        * 10;
            line[18] = '0' + GPS_coord[LON]              - (GPS_coord[LON]/10)         * 10;
